...
public class Person {
	...
	public Person(Integer userId, String firstName, String lastName, String email, String password, String cpassword,
			...
			Integer companyId, byte[] image, byte[] file, String imagename, String filename) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "Person [userId=" + userId + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email
				+ ", password=" + password + ", cpassword=" + cpassword + ", gender=" + gender + ", dob=" + dob
				...
				+ ", image=" + Arrays.toString(image) + ", file=" + Arrays.toString(file) + ", imagename=" + imagename
				+ ", filename=" + filename + "]";
	}
